...
-- 6. Modificar la tabla profesores_cursos para agregar la columna horas_clase
ALTER TABLE profesores_cursos ADD COLUMN horas_clase INT;

-- 7. Cambiar el tamaño del campo nombre en la tabla cursos
ALTER TABLE cursos MODIFY nombre VARCHAR(200) NOT NULL;

-- 8. Eliminar la columna horas_clase de la tabla profesores_cursos
...
-- 11. Añadir un curso llamado "Matemáticas" con una descripción
INSERT INTO cursos (nombre, descripcion) VALUES ('Matemáticas', 'Curso de álgebra y geometría');

-- 12. Asignar el profesor "Juan Pérez" al curso "Matemáticas" con fecha de asignación de hoy
...
-- 13. Insertar dos profesores adicionales ("Ana Rodríguez" y "Luis Gómez")
INSERT INTO profesores (nombre) VALUES ('Ana Rodríguez'), ('Luis Gómez');

-- 14. Añadir tres cursos adicionales ("Física", "Historia", "Química")
...
AND curso_id = (SELECT id FROM cursos WHERE nombre = 'Historia');
